...
<article <?php look_ruby_markup_article(); post_class( 'post-wrap post-slider is-light-text post-slider-hw is-background-post' ); ?> style="background-image: url(<?php echo esc_url( $look_ruby_featured_attachment[0] ); ?>)">
