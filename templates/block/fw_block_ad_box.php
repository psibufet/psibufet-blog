...
/**
 * Class look_ruby_fw_block_ad_box
 * render has fullwidth block code
 */
if ( ! class_exists( 'look_ruby_fw_block_ad_box' ) ) {
	class look_ruby_fw_block_ad_box extends look_ruby_block {
		...
		static function render( $block ) {
			...
			$block['block_classes'] = 'fw-block block-ad-box';
