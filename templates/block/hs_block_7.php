...
/**
 * Class look_ruby_hs_block_7
 * render has sidebar block 4
 */
if ( ! class_exists( 'look_ruby_hs_block_7' ) ) {
	class look_ruby_hs_block_7 extends look_ruby_block {
		...
		static function render( $block ) {
			...
			$block['block_classes'] = 'hs-block hs-block-7';
				...
				while ( $data_query->have_posts() ) :
					...
					if ( true === $flag ) : ?>
						<div class="is-left-col col-sm-8 col-sx-12">
							<?php get_template_part( 'templates/module/layout', 'overlay' ); ?>
						</div>

						<div class="is-right-col col-sm-4 col-xs-12">
						<?php $flag = false; ?>
					<?php else: ?>
						<?php get_template_part( 'templates/module/layout', 'list_mini' ); ?>
					<?php
					endif;
				endwhile; ?>
				</div>
