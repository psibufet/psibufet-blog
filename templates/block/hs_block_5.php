...
/**
 * Class look_ruby_hs_block_5
 * render has sidebar block 5
 */
if ( ! class_exists( 'look_ruby_hs_block_5' ) ) {
	class look_ruby_hs_block_5 extends look_ruby_block {
		...
		static function render( $block ) {
			...
			$block['block_classes'] = 'hs-block hs-block-5';
